...
/**
* CLASS NAME  : LPK_Health
* DESCRIPTION : Class which manages health of a character.
**/
public class LPK_Health : LPK_LogicBase
{
    ...
    * DESCRIPTION  : Initializes Health Modification detection.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Sets detecing health modification events.
