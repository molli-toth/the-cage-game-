...
public class LPK_TrackingCamera : LPK_LogicBase
{
    ...
    /**
    * CLASS NAME  : TrackingCameraMove_Event
    * DESCRIPTION : Event to communicate to objects when important objects move.
    **/
    ...
    * INPUTS       : scalar - Value to modify the size of the camera by.
    ...
    **/
    ...
    /**
    * FUNCTION NAME: SendDistanceEvent
    * DESCRIPTION  : Notifies important objects as to the camera's location.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: AddImportantObject
    * DESCRIPTION  : Adds an object to the list of important objects.
    * INPUTS       : data - ImportantObjectAdd_Event
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: RemoveImportantObject
    * DESCRIPTION  : Removes an object to the list of important objects.
    * INPUTS       : data - ImportantObjectRemove_Event
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Used to remove the object add and remove events as they are not
