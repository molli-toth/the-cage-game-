...
public class LPK_LogicBase : MonoBehaviour
{
    ...
    /**
    * FUNCTION NAME: Start
    * DESCRIPTION  : Sets up pause event listening and calls OnStart.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    void Start()
    ...
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: GetPauseStatus
    * DESCRIPTION  : Get the pause status of the object.  Useful for input functions.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Prevent game action from proceeding of paused, alongside
    ...
    **/
    ...
    /**
    * FUNCTION NAME: UsesUpdate
    * DESCRIPTION  : Used by DebugStatistics to track perfermance of objects.
    * INPUTS       : None
    * OUTPUTS      : bool - True/false value of if Update is used by the component outside of the LogicBase
    **/
    ...
    * INPUTS       : objects     - List to return objects in.
    ...
    **/
    ...
    /**
    * FUNCTION NAME: OnPauseEvent
    * DESCRIPTION  : Detects game pause state.
    * INPUTS       : data - Activating trigger.
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: OnUnpauseEvent
    * DESCRIPTION  : Detects game unpause state.
    * INPUTS       : data - Activating trigger.
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnCollisionEnter
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnCollisionStay
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnCollisionExit
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnTriggerEnter
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnTriggerStay
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnTriggerExit
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnCollisionStay2D
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnCollisionExit2D
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnTriggerStay2D
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: LPK_OnTriggerExit2D
    * DESCRIPTION  : Implemented by child classes.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * INPUTS       : obj - Object to check for collision validation.
    ...
    * DESCRIPTION  : Detects when the mouse has clicked this object.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    void OnMouseDown()
    ...
    * DESCRIPTION  : Detects when the mouse has released anywhere.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    void OnMouseUp()
    ...
    /**
    * FUNCTION NAME: OnMouseUp
    * DESCRIPTION  : Detects when the mouse has released over the same object it clicked on.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Set up a function to respond to a certain event.
    * INPUTS       : eventTrigger  - Event for the function to respond to.
    ...
    * DESCRIPTION  : Determine whether or not to respond to an event.
    * INPUTS       : data - Event data to parse for recivers.
    * OUTPUTS      : bool - True or false whether or not to respond to event.
    **/
    ...
    * DESCRIPTION  : Determine whether or not to respond to an input event based on pressed data.
    * INPUTS       : data - Event data to parse input on.
    * OUTPUTS      : bool - True or false whether or not to respond to event.
    **/
    ...
    * INPUTS       : caller  - Unity object (component) that invoked this function.
    ...
    * DESCRIPTION  : Handle object destruction.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    void OnDestroy()
    ...
    **/
    ...
    /**
    * FUNCTION NAME: DetachFunction
    * DESCRIPTION  : Detach a function from every possible handler.
    * INPUTS       : eventFunction - Function to detach.
    * OUTPUTS      : None
    **/
...
/**
* CLASS NAME  : LPK_EventList
* DESCRIPTION : Formated event list for view in the Unity Editor.
**/
[System.Serializable]
public class LPK_EventList
{
    ...
    * DESCRIPTION  : Initialize all arrays to not be null.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
...
/**
* CLASS NAME  : LPK_EventReceivers
* DESCRIPTION : Serialized class to specify search targets for event dispatching.
**/
[System.Serializable]
public class LPK_EventReceivers
{
    ...
    /**
    * FUNCTION NAME: Constructor
    * DESCRIPTION  : Constructor for array initialization.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
...
/**
* CLASS NAME  : LPK_EventManager
* DESCRIPTION : Messaging system implementation.
**/
public static class LPK_EventManager
{
    ...
    public struct LPK_EventData
    {
        /**
        * FUNCTION NAME: Constructor
        * DESCRIPTION  : Constructor for data paramater only taking sender and
        *                receiver information.
        * INPUTS       : sender   - Game Object sending the event.
    ...
    /**
    * FUNCTION NAME: InvokeEvent
    * DESCRIPTION  : Invokes a specified event.
    * INPUTS       : eventCalled - Which type of event to invoke.
...
/**
* CLASS NAME  : LPK_DebugStatistics
* DESCRIPTION : Keeps track of stats regarding LPK usage for perfermance debugging.
...
static class LPK_DebugStatistics
{
    ...
    /**
    * FUNCTION NAME: AddObjectCount
    * DESCRIPTION  : Notifies statistics of a potential new object add.
    * INPUTS       : _newObject - Object to be counted in the stats.
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: RemoveObjectCount
    * DESCRIPTION  : Notifies statistics of a potential object to remove.
    * INPUTS       : _removeObject - Object to be removed in the stats.
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: AddUpdatedObjectCount
    * DESCRIPTION  : Notifies statistics of a potential updated object to add.
    * INPUTS       : _removeObject - Object to be added in the stats.
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: RemoveUpdatedObjectCount
    * DESCRIPTION  : Notifies statistics of a potential updated object to remove.
    * INPUTS       : _removeObject - Object to be removed from the stats.
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: GetTotalObjectCount
    * DESCRIPTION  : Returns the total count of LPK objects.
    * INPUTS       : None
    * OUTPUTS      : uint - Total count of LPK objects in the game.
    **/
    ...
    /**
    * FUNCTION NAME: GetTotalUpdatedObjectCount
    * DESCRIPTION  : Returns the total count of LPK objects that use Update.
    * INPUTS       : None
    * OUTPUTS      : uint - Total count of LPK objects in the game that use update.
    **/
    ...
    /**
    * FUNCTION NAME: GetTotalComponentCount
    * DESCRIPTION  : Returns the total count of LPK components currently in use.
    * INPUTS       : None
    * OUTPUTS      : uint - Total count of LPK components in the game.
    **/
    ...
    /**
    * FUNCTION NAME: GetTotalUpdatedComponentCount
    * DESCRIPTION  : Returns the total count of LPK components that use Update.
    * INPUTS       : None
    * OUTPUTS      : uint - Total count of LPK components that use Update in the game.
    **/
