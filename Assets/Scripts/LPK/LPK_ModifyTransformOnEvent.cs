...
public class LPK_ModifyTransformOnEvent : LPK_LogicBase
{
    ...
    * DESCRIPTION  : Preforms change on transform of desired object.
    ...
    * DESCRIPTION  : Preforms change on transform of desired object in world space.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Preforms change on transform of desired object in local space.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
