...
/**
* CLASS NAME  : LPK_ShootAtMouse
* DESCRIPTION : Component to spawn an object and shoot it towards the mouse.
**/
public class LPK_ShootAtMouse : LPK_LogicBase
{
    ...
    * DESCRIPTION  : Initializes m_iMouseButton;
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
     * FUNCTION NAME: SpawnObjectPrefab
     * DESCRIPTION  : Spawns the prefab object and fires it towards mouse.
     * INPUTS       : None
     * OUTPUTS      : None
     **/
    ...
    * DESCRIPTION  : Creates a delay between spawns.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    **/
    ...
    /**
    * FUNCTION NAME: DispatchLPKMouseInputEvent
    * DESCRIPTION  : Dispatches the mouse event and prints debug info if set.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    /**
    * FUNCTION NAME: DispatchLPKSpawnEvent
    * DESCRIPTION  : Dispatches the spawn object event.
    * INPUTS       : obj - Gameobject created to add to the array of event receivers.
    * OUTPUTS      : None
    **/
