...
public class LPK_DynamicPlatformerController : LPK_LogicBase
{
    ...
    **/
    ...
    /**
    * FUNCTION NAME: CheckGroundedRaycast
    * DESCRIPTION  : Checks grounded via raycast detection.
    * INPUTS       : None
    * OUTPUTS      : None
    **/
    ...
    * DESCRIPTION  : Manages collision detection for grounding the character.  Super basic.
